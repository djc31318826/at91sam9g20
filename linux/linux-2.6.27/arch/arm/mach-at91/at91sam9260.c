...
static struct map_desc at91sam9g20_sram_desc[] __initdata = {
	{
		...
		.virtual	= AT91_IO_VIRT_BASE - AT91SAM9G20_SRAM0_SIZE - AT91SAM9G20_SRAM1_SIZE-AT91SAM9260_FPGA_MEM_SIZE,
		.pfn		= __phys_to_pfn(AT91SAM9260_FPGA_MEM_BASE),
		.length		= AT91SAM9260_FPGA_MEM_SIZE,
		.type		= MT_DEVICE,
	}
