...
for(i=0;i<6;i++)
{
	printf("NetServerEther[%d]=%2.2x\r\n",i,NetServerEther[i]);
}
*/
/*printf("TftpServerIP=%4.4x\r\n",TftpServerIP);
*/
/*
printf("len=%d\r\n",len);
printf("TftpServerPort=%d\r\n",TftpServerPort);
printf("TftpOurPort=%d\r\n",TftpOurPort);
printf("TftpServerIP=%d\r\n",TftpServerIP);
//printf("NetServerEther=%d\r\n",NetServerEther);
*/
