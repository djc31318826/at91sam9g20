...
void serial_setbrg(void)
{
	...
	(*(unsigned volatile long*)0x20000000)=USART3_BF(CD, divisor);
	(*(unsigned volatile long*)0x20000004)=usart_hz;
	//printf("@serial_setbrg\r\n");//BRGR=%d,divisor=%d,usart_hz=%d,CD=%d,USART3_BF(CD, divisor)=%d\r\n",BRGR,divisor,usart_hz,CD,USART3_BF(CD, divisor));
}
